...
def detect_objects(net, layer_names, img, conf_threshold):
...
def loop_and_detect(cam, net, layer_names, classes, conf_th, window_name, ocr_model=None):
    ...
    while True:
        ...
        boxes, confs, clss = detect_objects(net, layer_names, img, conf_th)
...
def process_camera(args, cam_index):
    ...
    net = cv2.dnn.readNetFromDarknet(args.model, args.weights)
    ...
    loop_and_detect(cam, net, output_layers, classes, args.conf_thresh, window_name=window_name)
